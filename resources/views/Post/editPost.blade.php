	...
	<form action="{{route('update.post')}}" method="post" id="form">
		...
		<div class="row">
    		...
    		<div class="form-group col-md-4">
    			...
    			<input type="number" oninput="numberOnly(this.id);" maxlength="3" minlength="1" min="1" max="135" id="age" class="form-control" name="age" placeholder="Age" required maxlength="3" value="{{$posts->age}}">
    		</div>
		</div>
		<div class="row">
			<div class="col-md-4 col-sm-4"></div>
